...
module.exports = ".upload-btn-wrapper {\r\n    position: relative;\r\n    overflow: hidden;\r\n    display: inline-block;\r\n  }\r\n  \r\n  .btncss {\r\n    border: 2px solid gray;\r\n    color: gray;\r\n    background-color: white;\r\n    padding: 8px 20px;\r\n    border-radius: 8px;\r\n    font-size: 20px;\r\n    font-weight: bold;\r\n  }\r\n  \r\n  .upload-btn-wrapper input[type=file] {\r\n    font-size: 100px;\r\n    position: absolute;\r\n    left: 0;\r\n    top: 0;\r\n    opacity: 0;\r\n  }\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<!-- <nav class=\"navbar navbar-expand-lg navbar-light bg-light\">\n  <a class=\"navbar-brand\" href=\"#\">Maapilim Israel</a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\"\n    aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n  <input type=\"file\" name=\"photo\" ng2FileSelect [uploader]=\"uploader\" />\n\n  <button type=\"button\" class=\"btn btn-secondary btn-s\" (click)=\"uploader.uploadAll()\" [disabled]=\"!uploader.getNotUploadedItems().length\">\n    Upload\n  </button>\n\n</nav> -->\n\n<nav class=\"navbar navbar-expand-lg navbar-light bg-light\">\n  <a class=\"navbar-brand\" href=\"#\">Maapilim Israel Inventory</a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\"\n    aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n  <div>\n    <button class=\"btn btn-secondary\" (click)=\"this.reloadPage()\">Reload</button>\n  </div>\n  <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">\n    <ul class=\"navbar-nav mr-auto\">\n      \n    </ul>\n    <input type=\"file\" name=\"photo\" ng2FileSelect [uploader]=\"uploader\" />\n\n  <button type=\"button\" class=\"btn btn-secondary btn-s\" (click)=\"uploader.uploadAll()\" [disabled]=\"!uploader.getNotUploadedItems().length\">\n    Upload\n  </button>\n  </div>\n</nav>\n"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(http, el) {
        this.http = http;
        this.el = el;
        this.uploader = new ng2_file_upload_ng2_file_upload__WEBPACK_IMPORTED_MODULE_2__["FileUploader"]({ url: URL, itemAlias: 'products-icount' });
    }
    NavbarComponent.prototype.ngOnInit = function () {
        ...
        this.uploader.onCompleteItem = function (item, response, status, headers) {
            _this.last_update = new Date(item['_file']['lastModified']);
        };
    };
    NavbarComponent.prototype.reloadPage = function () {
        window.location.reload();
    };
    NavbarComponent.prototype.upload = function () {
        //locate the file element meant for the file upload.
        var inputEl = this.el.nativeElement.querySelector('#products-icount');
        ...
        if (fileCount > 0) { // a file was selected
            ...
            this.http
                ...
                .post(URL, formData).subscribe(function (res) { console.log(res); window.location.reload(); }
    ...
    NavbarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]])
    ], NavbarComponent);
...
module.exports = "<div class=\"container\">\n\n<div style=\"direction: rtl; text-align:right\" class=\"mt-4\"> \n    <h4>{{ product?.Name}}({{ product?.SKU }})</h4>\n    <!-- <button class=\"btn btn-danger\" (click)=\"renderGraphs()\">Double Click for Graphs</button> -->\n\n</div>\n<div *ngIf=\"isOn\">\n   \n    <div class=\"container text-center\">\n            <h3 class=\"m-3\">גרף מכירות לפי תאריך</h3>\n        <div>\n            <canvas id=\"canvas\">{{ chart }}</canvas>\n        </div> \n    </div>\n    <div class=\"text-center mt-4\">\n            <h3 class=\"m-3\">כניסות סחורה</h3>\n        <table  class=\"table table-hover\" style=\"direction: rtl; text-align: right\">\n            <thead>\n            <tr>\n                <td>תאריך</td>\n                <td>כמות</td>\n            </tr>\n        </thead>\n            <tbody>\n                <tr *ngFor=\"let stamp of importStamps\" >\n                    <td>{{ stamp?.time }}</td>\n                    <td>{{ stamp?.value }}</td>              \n                </tr>\n            </tbody>\n          </table>\n    </div>\n</div>"
...
var ProductDetailsComponent = /** @class */ (function () {
    function ProductDetailsComponent(route, ps) {
        this.route = route;
        this.ps = ps;
        this.stamps = [];
        this.values = [];
    ...
    ProductDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.ps
            ...
            _this.getArrays(data['Stamps']);
            _this.product = data;
        });
    };
    ProductDetailsComponent.prototype.getTime = function (timestamp) {
    ...
    ProductDetailsComponent.prototype.getArrays = function (stamp) {
        this.stamps = [];
        this.values = [];
        var _loop_1 = function (i) {
            var element = stamp[i];
            var stamps = Object.keys(element);
            var values = Object.keys(element).map(function (key) {
                return element[key];
            });
            if (values[0] < 0) {
                this_1.stamps.push(this_1.getTime(stamps[0]));
                this_1.values.push(-1 * values[0]);
            }
            else {
                this_1.importStamps.push({ time: this_1.getTime(stamps[0]), value: values[0] });
            }
        };
        var this_1 = this;
    ...
    ProductDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _products_service__WEBPACK_IMPORTED_MODULE_3__["ProductsService"]])
...
module.exports = "<div class=\"container p-4\">\n  <h1 class=\"text-center mt-3\">מוצרי מעפילים ישראל</h1>\n  <h5 class=\"text-center mb-3\">עודכן לאחרונה: {{ date  | date: 'dd/MM/yyyy'}} </h5>\n    <table class=\"table table-hover\" style=\"direction: rtl; text-align: right\">\n        <thead>\n        <tr>\n            <td>מקט</td>\n            <td>שם המוצר</td>\n            <td>כמות</td>\n            <td>תנועה אחרונה</td>\n            <td>סה\"כ (החל מפברואר)</td>\n            <td>דינאמיות</td>\n\n     \n        </tr>\n        </thead>\n      \n        <tbody>\n            <tr routerLink=\"/products/{{ product._id }}\" *ngFor=\"let product of products\" >\n                <td>{{ product.SKU }}</td>\n                <td>{{ product.Name }}</td>\n                <td>{{ product.Quantity }}</td>\n                <td>{{ product.daily}} ( {{ product.today_date | date: 'dd/MM/yyyy'}} )</td>\n                <td>{{ product.monthly}}</td>\n                <td>{{ product.dynamic}}</td>\n          \n              \n            </tr>\n        </tbody>\n      </table>\n</div>\n"
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(ps) {
        this.ps = ps;
    }
    ProductListComponent.prototype.ngOnInit = function () {
        ...
        this.ps
            ...
            .subscribe(function (data) {
            _this.products = data;
            _this.products = _this.productsGetToday(_this.products);
            _this.products = _this.productsGetMonth(_this.products);
            console.log(_this.products);
        });
        this.ps.getDate().subscribe(function (data) {
            _this.date = data[0]['last_update'];
        });
    };
    ProductListComponent.prototype.productsGetMonth = function (products) {
        for (var i = 0; i < products.length; i++) {
            var monthQuantity = 0;
            var element = products[i]['Stamps']; // element = [{1243253: 3, 13253425: -11}] ..
            var _loop_1 = function (j) {
                var quantity_stamp = element[j];
                var values = Object.keys(quantity_stamp).map(function (key) {
                    return quantity_stamp[key];
                });
                if (Object(util__WEBPACK_IMPORTED_MODULE_3__["isNumber"])(values[0]) && values[0] < 0) {
    ...
    ProductListComponent.prototype.productsGetToday = function (products) {
        var _this = this;
        products.forEach(function (element) {
            element['daily'] = 0;
            // takes the last stamp as objecs e,.g { 15043594329: 4}
            var todayStamp = element['Stamps'][element['Stamps'].length - 1];
            // takes its value
            if (todayStamp) {
                var values = Object.keys(todayStamp).map(function (key) {
                    return todayStamp[key];
                });
                var keys = Object.keys(todayStamp);
                // assign it to 'today' dynamic attribute
                if (Object(util__WEBPACK_IMPORTED_MODULE_3__["isNumber"])(values[0]) && values[0] < 0) {
                    element['daily'] = values[0] * -1;
                    element['today_date'] = _this.getTime(keys[0]);
                }
                else {
                    element['daily'] = 0;
                }
    ...
    ProductListComponent.prototype.getTime = function (timestamp) {
...
var ProductsService = /** @class */ (function () {
    ...
    ProductsService.prototype.getDate = function () {
...
module.exports = __webpack_require__(/*! C:\Users\user\Desktop\מעפילים\Maapilim-Inventory\src\main.ts */"./src/main.ts");
